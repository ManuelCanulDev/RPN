...
//ciclo para recorrer todos los elementos que estan en postfijo
while(i <= seq.length) {
var item = seq[i]
//console.log(item)
var index = operands.indexOf(item)
//Si no hay nada se agrega a stack
if (index < 0) {
  stack.push(seq[i])
} else {
  //si el caracter es un operando, hacer la operacion correspondiente
  ...
  //verifica los operandos logicos
  if(index == 5) {
      stack.push(b < a);
  }
  if(index == 6) {
